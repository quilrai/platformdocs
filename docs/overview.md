...
<div className="not-prose mt-8 grid gap-4 md:grid-cols-2 xl:grid-cols-3">
  ...
  <div className="rounded-xl border border-[#c7b99f] bg-[#ebe1cf] p-5 dark:border-[#30343b] dark:bg-[#1f232a]">
    ...
    <p className="mb-0 mt-2 text-sm leading-6 text-[#554c3f] dark:text-neutral-400">
      Maintain a live inventory across Browser Extension, Endpoint Agent, LLM Gateway, MCP Gateway, SaaS cloud accounts, and compliance API sources.
    </p>
  </div>
  <div className="rounded-xl border border-[#c7b99f] bg-[#ebe1cf] p-5 dark:border-[#30343b] dark:bg-[#1f232a]">
...
AI Inventory helps teams track AI assets and AI activity sources from one place. Source views include Browser Extension applications, Endpoint Agent applications and coding inventory, LLM Gateway API keys, MCP Gateway servers, SaaS assets (including a licensed SaaS Cloud Inventory view for AWS and Microsoft Copilot Studio), and Compliance APIs for supported providers.
